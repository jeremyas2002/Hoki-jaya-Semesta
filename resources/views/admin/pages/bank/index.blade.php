        ...
        <div class="section-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('admin.bank.create') }}" class="btn btn-sm btn-primary mb-3"><i
